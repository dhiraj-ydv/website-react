  ...
  <section id="about">
    <div className="space-y-4">
      ...
      <p className="section-content">
        ...
        cosmology, sociology, and qualitative fundamental analysis. I also enjoy gymming and playing tactical FPS games. Feel free to explore my blog for more insights.
      </p>
      <div>
